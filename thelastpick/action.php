...
if(isset($_POST["get_seleted_Category"]) || isset($_POST["selectBrand"]) || isset($_POST["search"])){
	...
	while($row=mysqli_fetch_array($run_query)){
			...
			$query11 = "SELECT * FROM `user_info` WHERE user_id = ".$_SESSION["uid"].";";
			} else{
			    $query11 = "SELECT * FROM `user_info` WHERE user_id = ".$uid.";";
			}
		    ...
		    if(isset($_SESSION["uid"])){
			$query12 = "UPDATE `user_info` SET p_id1 = ".$pro_id.", p_id2 = ".$pid1.",  p_id3 = ".$pid2." WHERE user_id = ".$_SESSION["uid"].";";
		    } else{
			    $query12 = "SELECT * FROM `user_info` WHERE user_id = ".$uid.";";
			}
			...
			echo "<form method='post' action='login_form.php'>";
				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="https://www.payumoney.com/merchant-account/#/login" method="post">';
							...
							echo   
								'
									...
									<input style="float:right;margin-right:80px;" type="image" name="submit"
										src="https://d31eg7vyu9l0qx.cloudfront.net/app/uploads/2017/01/image01.jpg" alt="PayU Checkout"
										alt="PayU - The safer, easier way to pay online">
								</form>';
				}
			}
	}
