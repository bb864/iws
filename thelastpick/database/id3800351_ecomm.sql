...
--
-- Host: localhost:3306
-- Generation Time: Dec 01, 2017 at 07:04 AM
...
(3, 45, '103.27.164.14', 6, 1),
(5, 45, '103.27.164.38', 3, 1),
(6, 1, '106.67.47.212', 4, 1),
(7, 46, '106.202.236.43', 5, 1),
(8, 6, '106.202.236.43', 5, 1),
(9, 22, '106.202.141.141', 3, 3),
(10, 27, '106.202.141.141', 3, 1),
(11, 34, '106.202.141.141', 3, 1);
...
(1, 3, 7, 1, '07M47684BS5725041', 'Completed'),
(2, 3, 2, 1, '07M47684BS5725041', 'Completed');
...
(1, 1, 2, 'Samsung Dous 2', 5000, 'Samsung Dous 2 sgh ', 'samsung mobile.jpg', 'samsung mobile electronics Samsung Dous 2'),
(2, 1, 3, 'iPhone 5s', 25000, 'iphone 5s', 'iphone mobile.jpg', 'mobile iphone apple iPhone 5s'),
(3, 1, 3, 'iPad', 30000, 'ipad apple brand', 'ipad.jpg', 'apple ipad tablet iPad'),
(4, 1, 3, 'iPhone 6s', 32000, 'Apple iPhone ', 'iphone.jpg', 'iphone apple mobile iPhone 6s'),
(5, 1, 2, 'iPad 2', 10000, 'samsung ipad', 'ipad 2.jpg', 'ipad tablet iPad 2'),
...
(33, 6, 2, 'Refrigerator', 35000, 'Refrigerator', 'CT_WM_BTS-BTC-AppliancesHome_20150723.jpg', 'refrigerator'),
(34, 6, 4, 'Emergency Light', 1000, 'Emergency Light', 'emergency light.JPG', 'emergency light'),
(35, 6, 0, 'Vaccum Cleaner', 6000, 'Vaccum Cleaner', 'vacuum.jpeg', 'Vaccum Cleaner'),
(36, 6, 5, 'Iron', 1500, 'gj', 'iron.JPG', 'iron'),
(37, 6, 5, 'LED TV', 20000, 'LED TV', 'led.jpg', 'led tv lg'),
(38, 6, 4, 'Microwave Oven', 3500, 'Microwave Oven', 'microwave.jpg', 'Microwave Oven'),
...
CREATE TABLE `user_info` (
  ...
  `p_id1` int(11) NOT NULL DEFAULT '1',
  `p_id2` int(11) NOT NULL DEFAULT '2',
  `p_id3` int(11) NOT NULL DEFAULT '3',
...
INSERT INTO `user_info` (`user_id`, `first_name`, `last_name`, `email`, `password`, `p_id1`, `p_id2`, `p_id3`, `mobile`, `address1`, `address2`) VALUES
(3, 'Krishna', 'Hariramani', 'krishzinx@gmail.com', 'a99298933795168bec6b98aad415016c', 27, 26, 25, '9654123864', '49, First Floor, Jacaranda Marg,', 'DLF City - '),
(4, 'VAIBHAv', 'saxena', 'vyomsaxena@ymail.com', '37a352ec118cb7d469f4d9ea7bdde609', 46, 45, 33, '8726926154', '339/27 triveniganj naubasta  near lal school  lucknow 226003', 'Gshsbaba'),
(5, 'Jitendra', 'Bhati', 'jitu@hotmail.com', 'f31acd29217fbe4e75819c56830926f7', 38, 34, 8, '1234567890', 'sdfd', 'fasdsf'),
(6, 'Nilesh', 'Gupta', 'ng9454@gmail.com', 'a9de60fa4edd6bdea5bc7c20d8354df0', 1, 2, 3, '9560768206', 'F-193, Beta-2', 'G. Noida'),
(7, 'Nilesh', 'Gupta', 'ng9454@gmaisl.com', 'a9de60fa4edd6bdea5bc7c20d8354df0', 1, 2, 3, '9560768206', 'F-193, Beta-2', 'G. Noida'),
(8, 'Nilesh', 'Gupta', 'ng945@yahoo.com', '8dd43ae0638e1ce2690e2e3cfa653923', 1, 2, 3, '9560768206', 'F-193, Beta-2', 'G. Noida');
